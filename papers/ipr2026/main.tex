...
% ──────────────────────────────────────────────
\begin{abstract}
% NOTE TO AUTHORS: Revised to foreground the analytical contribution.
...
% NOTE TO AUTHORS: This section establishes the analytical lens for the
% comparative analysis. Please review and revise in your own voice.
...
% NOTE TO AUTHORS: Adapt this to accurately reflect your actual research process.
...
The AI Act's phased enforcement began on February 2, 2025, when the provisions banning prohibited AI practices---including social scoring, manipulative subliminal techniques, and most real-time remote biometric identification---became legally binding. On August 2, 2025, the GPAI model governance obligations took effect, requiring providers to comply with transparency and systemic-risk provisions, with penalties of up to \texteuro35~million or 7\% of global annual turnover. Full high-risk AI system requirements will apply from August 2026. These milestones mark the EU's transition from legislative ambition to operational enforcement.
...
\bottomrule
\end{tabularx}
\caption{Executive Order \#14110 on the Safe, Secure, and Trustworthy Development and Use of AI (* see Appendix~A for agency acronyms).}
