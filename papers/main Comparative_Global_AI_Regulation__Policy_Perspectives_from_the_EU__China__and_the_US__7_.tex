...
\title{Comparative Global AI Regulation: Policy Perspectives from the EU, China, and the US}
\author{
...
Beyond the societal effects, there is universal acknowledgement of the centrality of AI to related technologies like advanced chips, energy production and storage, 5G/6G telecommunications, satellites, and robotics. These illustrate the importance of AI to national economics, competitiveness, and security. Some argue that the EU's stricter AI regulation may inadvertently stifle innovation, deter investment, and weaken Europe's position in the global AI and technology race \citep{suominen2020rise}. The tension between regulatory safety and competitiveness is particularly evident in the dynamics between China and the US, with both nations striving to balance innovation with responsible AI development \citep{itif2024chinaai}.
...
Besides regulating the EU single market, the Act is widely regarded as a strategic effort by the European Commission to establish themselves as the leading AI rulemakers globally~\citep{noauthor_eus_2024}. Just as after the adoption of the GDPR in 2016~\citep{gdpr_article7}, it is speculated that companies across the world will begin to prioritize compliance with European AI law out of economic necessity, not through coercion~\citep{almada_brussels_2024}. In the case of the GDPR, this form of ``Brussels Effect''~\citep{bradford_brussels_2020} was complemented by a ``de jure'' effect in which countries with a lack of their own regulatory capacity, such as many developing countries,  incorporated EU laws instead. For example, the Philippinesincorporated the right to be forgotten into their Data Privacy Act of 2012~\cite{philippines2012dataprivacy,linklaters}. In a similar way, it is speculated that the EU AI Act may similarly become the de-facto standard for AI governance in much of the Western and developing world~\citep{almada_brussels_2024}. 
...
\begin{figure}
    ...
    \caption{The risk pyramid for AI systems (taken from \citep{madiega2024artificial})}
    \label{fig:figure2}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.88\linewidth]{figures/table_china_ailawsregulations.pdf} % Adjust the 1.0 value to change the percentage
    \caption{Chinese AI Laws and Regulations}
    \label{fig:table_china_ailawsregulations.pdf}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{figures/table_china_aimodelcompliance.pdf} % Adjust the 1.0 value to change the percentage
    \caption{ AI Model Compliance Steps in China}
    \label{fig:table_chinamodelcompliance}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{figures/table_useo14110_agencies.pdf} % Adjust the 1.0 value to change the percentage
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{figures/fig_casb1047_timeline.pdf} % Adjust the 0.9 value to change the percentage
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{figures/fig_casb1047_actions_immediate.pdf} % Adjust the 0.7 value to change the percentage
...
\begin{itemize}
  ...
  \item Katherine L. Elkins: The United States
\end{itemize}
Each author has reviewed each other's section and takes responsibility for the content of their own.

% References will be automatically generated based on the citations in the document
...
\section{Appendix A}
% Content for Appendix A to be added
