...
\usepackage{natbib}
\usepackage{url}
\usepackage[breaklinks]{hyperref} % Ensure that links break over lines
\usepackage{adjustbox} % Scale tables to fit the page width
\usepackage{float}
\usepackage{placeins}
\usepackage{indentfirst}
\usepackage[hyphens]{url}   % This allows breaking URLs at hyphens
\usepackage{hyperref}       % Ensures hyperlinks work
...
\author{
    ...
    \textsuperscript{2}Oxford University
}
\date{October 2024}
...
% Prevents floating elements (e.g., figures or tables) from causing a blank page
\FloatBarrier  
...
\clearpage  % Or \newpage if you don't have any pending floats
